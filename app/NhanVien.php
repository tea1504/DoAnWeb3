...
class NhanVien extends Model
{
    ...
    protected   $fillable       = ['nv_hoTen', 'nv_tenGoiKhac', 'nv_trinhDoChuyenMon', 'nv_ngaySinh', 'nv_noiSinh', 'dt_ma', 'tg_ma', 'nv_hoKhauThuongTru', 'nv_noiOHienNay', 'nv_ngayVaoDang', 'nv_ngayVaoDangChinhThuc', 'nv_ngayNhapNgu', 'nv_ngayXuatNgu', 'nv_quanHam', 'nv_sucKhoe', 'nv_chieuCao', 'nv_canNang', 'nm_ma', 'nv_hangThuongBinh', 'nv_giaDinhChinhSach', 'nv_cmnd', 'nv_bhxh', 'td_ma', 'username', 'password', 'nv_taoMoi', 'nv_capNhat', 'nv_anh', 'cvu_ma', 'nv_gioiTinh', 'nv_sdt', 'nv_email'];
