                ...
                <div class="card-body">
                    <form name="frmEdit" id="frmEdit" method="POST" action="{{route('admin.khenthuong.update', ['id' => $kt->kt_ma])}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="kt_ngayKy" name="kt_ngayKy" class="form-control" value="{{ old('kt_ngayKy', $kt->kt_ngayKy) }}" ng-class="frmEdit.kt_ngayKy.$invalid?'form-control is-invalid':'form-control is-valid'" ng-model="kt_ngayKy" ng-required="true">
                                <div class="invalid-feedback">
                                    <span ng-show="frmEdit.kt_ngayKy.$error.required">Bạn phải điền ngày ký</span>
                                </div>
                            </div>
                        </div>                                             
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="kt_lyDo" name="kt_lyDo" class="form-control" value="{{ old('$kt_lyDo', $kt->kt_lyDo) }}" ng-class="frmEdit.kt_lyDo.$invalid?'form-control is-invalid':'form-control is-valid'" ng-model="kt_lyDo" ng-required="true" ng-minlength="3" ng-maxlength="100">
                                <div class="invalid-feedback">
                                    <span ng-show="frmEdit.kt_lyDo.$error.required">Bạn phải điền lý do</span>
                                    <span ng-show="frmEdit.kt_lyDo.$error.minlength">Lý do quá ngắn, phải chứa ít nhất 3 ký tự</span>
                                    <span ng-show="frmEdit.kt_lyDo.$error.maxlength">Lý do quá dài, chỉ chứa nhiều nhất 100 ký tự</span>
                                </div>
                            </div>
                        </div> 
