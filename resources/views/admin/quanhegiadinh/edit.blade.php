...
@section('title')
Sửa danh sách quan hệ gia đình
@endsection
@section('custom-css')
...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Sửa danh sách quan hệ gia đình</li>
</ol>
@endsection
@section('content')
                ...
                <div class="">
                    <form method="post" name="frmEdit" id="frmEdit" action="{{ route('admin.quanhegiadinh.update', ['id' => $qhgd->qhgd_ma]) }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="qhgd_ten" name="qhgd_ten" class="form-control" value="{{ old('qhgd_ten', $qhgd->qhgd_ten) }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Mối quan hệ : </label>
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="qhgd_moiQuanHe" name="qhgd_moiQuanHe" class="form-control" value="{{ old('qhgd_moiQuanHe',$qhgd->qhgd_moiQuanHe) }}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="qhgd_" name="qhgd_namSinh" class="form-control" value="{{ old('qhgd_namSinh',$qhgd->qhgd_namSinh) }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Địa chỉ : </label>
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="qhgd_diaChi" name="qhgd_diaChi" class="form-control" value="{{ old('qhgd_diaChi',$qhgd->qhgd_diaChi) }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Nghề nghiệp : </label>
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="qhgd_ngheNghiep" name="qhgd_ngheNghiep" class="form-control" value="{{ old('qhgd_ngheNghiep',$qhgd->qhgd_ngheNghiep) }}" >
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Nước ngoài : </label>
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                    <input type="number" id="qhgd_nuocNgoai" name="qhgd_nuocNgoai" min="0" max="10" class="form-control" value="{{ old('qhgd_nuocNgoai',$qhgd->qhgd_nuocNgoai) }}" >                            
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Tạo mới : </label>
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="qhgd_taoMoi" name="qhgd_taoMoi" class="form-control" value="{{ old('qhgd_taoMoi',$qhgd->qhgd_taoMoi) }}" data-mask-datetime>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Cập nhật : </label>
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" id="qhgd_capNhat" name="qhgd_capNhat" class="form-control" value="{{ old('qhgd_capNhat',$qhgd->qhgd_capNhat) }}" data-mask-datetime>
                            </div>
                        </div>
