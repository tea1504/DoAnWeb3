...
@endsection
@section('content')
<div class="container-flu" ng-controller="quanhecapnhatController">
            ...
            <div class="card">
                ...
                <form name="frmEdit" id="frmEdit" method="POST" action="{{route('admin.quanhegiadinh.update', ['id' => $qhgd->qhgd_ma])}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-8">
                            <input type="text" name="qhgd_ten" id="qhgd_ten" value="{{old('qhgd_ten',$qhgd->qhgd_ten)}}" ng-class="frmEdit.qhgd_ten.$invalid?'form-control is-invalid':'form-control is-valid'" ng-model="qhgd_ten" ng-required="true" ng-minlength="3" ng-maxlength="100">
                                <div class="invalid-feedback">
