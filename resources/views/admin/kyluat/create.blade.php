...
@endsection
@section('content')
<div class="container-fluid" ng-controller="kyluatthemmoiController">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-cyan h1 font-weight-bold">Thêm mới kỷ luật</div>
                <div class="card-body">
                    <form name="frmCreate" id="frmCreate" method="POST" action="{{route('admin.kyluat.store')}}" novalidate>
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="date" id="kl_ngayKy" name="kl_ngayKy"  ng-class="frmCreate.kl_ngayKy.$touched?frmCreate.kl_ngayKy.$invalid?'form-control is-invalid':'form-control is-valid':'form-control'" ng-model="kl_ngayKy" ng-required="true" >
                                <div class="invalid-feedback">
                                    <span ng-show="frmCreate.kl_ngayKy.$error.required">Bạn phải ngày ký</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <select name="kl_nguoiKy" id="kl_nguoiKy" ng-class="frmCreate.kl_nguoiKy.$touched?frmCreate.kl_nguoiKy.$invalid?'form-control is-invalid':'form-control is-valid':'form-control'" ng-model="kl_nguoiKy" ng-required="true">
                                    @foreach($danhsachnhanvien as $nhanvien)
                                    <option value="{{ $nhanvien->nv_ma }}">{{ $nhanvien->nv_hoTen }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="invalid-feedback">
                                <span ng-show="frmCreate.kl_nguoiKy.$error.required">Bạn phải chọn nhân viên</span>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">Lý do : </label>
                            <div class="col-lg-10 col-md-9 col-sm-8">
                                <input type="text" name="kl_lyDo" id="kl_lyDo" ng-class="frmCreate.kl_lyDo.$touched?frmCreate.kl_lyDo.$invalid?'form-control is-invalid':'form-control is-valid':'form-control'" value="{{old('kl_lyDo')}}" ng-model="kl_lyDo" ng-required="true" ng-minlength="3" ng-maxlength="100">
                                <div class="invalid-feedback">
                                    <span ng-show="frmCreate.kl_lyDo.$error.required">Bạn phải lý do được thưởng</span>
                                    <span ng-show="frmCreate.kl_lyDo.$error.minlength">Lý quá ngắn, phải chứa ít nhất 3 ký tự</span>
                                </div>                            
                            </div>
                        </div>
...
<script>
    ...
    app.controller('kyluatthemmoiController', function($scope, $http) {});
</script>
