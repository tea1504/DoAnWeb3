    ...
    var table = $('#myTable').DataTable({
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    return `
                            <a href="/admin/vanbang/${data['vbcc_ma']}/edit" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Sửa" onmouseleave="hidetooltip()"><i class="fa fa-edit" aria-hidden="true"></i></a>
