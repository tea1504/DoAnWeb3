      ...
      <div class="card">
        ...
        <form name="frmCreate" id="frmCreate" method="POST" action="{{route('admin.tuyendung.store')}}" novalidate>
            ...
            <div class="form-group">
              ...
              <select name="nv_ma" class="form-control" id="nv_ma" >
              <option value=""></option>
                  @foreach($dsnv as $nv)
            ...
            <div class="row form-group">
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" ng-class="frmCreate.td_ngay.$touched?frmCreate.td_ngay.$invalid?'form-control is-invalid':'form-control is-valid':'form-control'" id="td_ngay" name="td_ngay" value="{{ old('td_ngay')}}" ng-model="td_ngay" ng-required="true" ng-pattern="/^[0-9]{4}\-[0-9]{2}\-[0-9]{2}/" 
                  ng-minlength="7" ng-maxlength="11" data-toggle="tooltip" data-placement="top" title="Điền theo định dạng năm-tháng-ngày. VD:2020-01-20" data-html="true" data-template='<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner bg-cyan border"</div></div>'>
                </div>
            ...
            <div class="row form-group">
              <div class="col">
                <div class="form-group">
                  ...
                  <select name="cvu_ma" ng-class="frmCreate.cvu_ma.$touched?frmCreate.cvu_ma.$invalid?'form-control is-invalid':'form-control is-valid':'form-control'" ng-model="cvu_ma" ng-required="true">
                    <option value=""></option>
                    @foreach($dscv as $cv)
              ...
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="text"  ng-class="frmCreate.td_ngayLam.$touched?frmCreate.td_ngayLam.$invalid?'form-control is-invalid':'form-control is-valid':'form-control'"  class="form-control" id="td_ngayLam" name="td_ngayLam" value="{{old('td_ngayLam')}} " ng-model="td_ngayLam" ng-minlength="7"
                        ng-maxlength="11" ng-required=true ng-pattern="/^[0-9]{4}\-[0-9]{2}\-[0-9]{2}/" data-toggle="tooltip" data-placement="top" title="Điền theo định dạng năm-tháng-ngày. VD:2020-01-20" data-html="true" data-template='<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner bg-cyan border"</div></div>'>
                </div>
              </div>
              <div class="invalid-feedback">
