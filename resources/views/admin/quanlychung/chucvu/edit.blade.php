...
@endsection
@section('content')
<div class="container-fluid" ng-controller="quanlythemmoiController" ng-init="cvu_ten = '{{old('cvu_ten', $cvu->cvu_ten)}}'">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-cyan h1 font-weight-bold">Cập nhật chức vụ</div>
                <div class="card-body">
                    <form name="frmEdit" id="frmEdit" method="POST" action="{{route('admin.chucvu.update', ['id' => $cvu->cvu_ma])}}" enctype="multipart/form-data" novalidate>
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" value="PUT">
                        <div class="form-group">
                            <label for="cvu_ten">Tên chức vụ :</label>
                            <input type="text" name="cvu_ten" id="cvu_ten" ng-model="cvu_ten" ng-class="['form-control', frmEdit.cvu_ten.$touched?frmEdit.cvu_ten.$invalid?'is-invalid':'is-valid':'']" ng-model="cvu_ten" ng-required="true" ng-minlength="3" ng-maxlength="50">
                            <div class="invalid-feedback">
                                <span ng-if="frmEdit.cvu_ten.$error.required">Bạn phải nhập vào trường này</span>
                                <span ng-if="frmEdit.cvu_ten.$error.minlength">Bạn nhập quá ngắn</span>
                                <span ng-if="frmEdit.cvu_ten.$error.maxlength">Bạn nhập quá dài</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="cvu_moTa">Mô tả :</label>
                            <textarea name="cvu_moTa" id="cvu_moTa" cols="30" rows="10" class="textarea">{{old('cvu_moTa', $cvu->cvu_moTa)}}</textarea>
                        </div>
                        <div class="form-group">
