...
@section('title')
Cập nhật loại văn bằng chứng chỉ
@endsection
@section('custom-css')
...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Cập nhật loại văn bằng chứng chỉ</li>
</ol>
@endsection
@section('content')
<div class="container-fluid" ng-controller="quanlythemmoiController" ng-init="lvbcc_ten = '{{old('lvbcc_ten', $lvbcc->lvbcc_ten)}}'">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-cyan h1 font-weight-bold">Cập nhật loại văn bằng chứng chỉ</div>
                <div class="card-body">
                    <form name="frmEdit" id="frmEdit" method="POST" action="{{route('admin.loaivbcc.update', ['id' => $lvbcc->lvbcc_ma])}}" enctype="multipart/form-data" novalidate>
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" value="PUT">
                        <div class="form-group">
                            <label for="lvbcc_ten">Tên loại văn bằng chứng chỉ :</label>
                            <input type="text" name="lvbcc_ten" id="lvbcc_ten" ng-model="lvbcc_ten" ng-class="['form-control', frmEdit.lvbcc_ten.$invalid?'is-invalid':'is-valid']" ng-model="lvbcc_ten" ng-required="true" ng-minlength="3" ng-maxlength="50">
                            <div class="invalid-feedback">
                                <span ng-if="frmEdit.lvbcc_ten.$error.required">Bạn phải nhập vào trường này</span>
                                <span ng-if="frmEdit.lvbcc_ten.$error.minlength">Bạn nhập quá ngắn</span>
                                <span ng-if="frmEdit.lvbcc_ten.$error.maxlength">Bạn nhập quá dài</span>
                            </div>
                        </div>
                        <div class="form-group">
