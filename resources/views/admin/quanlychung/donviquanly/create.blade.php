...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Thêm mới đơn vị quản lý</li>
</ol>
@endsection
@section('content')
<div class="container-fluid" ng-controller="quanlythemmoiController" ng-init="dvql_ten = '{{old('dvql_ten')}}'">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-cyan h1 font-weight-bold">Thêm mới đơn vị quản lý</div>
                <div class="card-body">
                    <form name="frmCreate" id="frmCreate" method="POST" action="{{route('admin.donviquanly.store')}}" enctype="multipart/form-data" novalidate>
                        {{ csrf_field() }}
                        <div class="form-group">
                            <label for="dvql_ten">Tên đơn vị quản lý :</label>
                            <input type="text" name="dvql_ten" id="dvql_ten" ng-model="dvql_ten" ng-class="['form-control', frmCreate.dvql_ten.$touched?frmCreate.dvql_ten.$invalid?'is-invalid':'is-valid':'']" ng-model="dvql_ten" ng-required="true" ng-minlength="3" ng-maxlength="50">
                            <div class="invalid-feedback">
                                <span ng-if="frmCreate.dvql_ten.$error.required">Bạn phải nhập vào trường này</span>
                                <span ng-if="frmCreate.dvql_ten.$error.minlength">Bạn nhập quá ngắn</span>
                                <span ng-if="frmCreate.dvql_ten.$error.maxlength">Bạn nhập quá dài</span>
                            </div>
                        </div>
                        <div class="form-group">
