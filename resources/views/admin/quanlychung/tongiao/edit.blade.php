...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active">Cập nhật tôn giáo</li>
</ol>
@endsection
@section('content')
<div class="container-fluid" ng-controller="quanlythemmoiController" ng-init="tg_ten = '{{old('tg_ten', $tg->tg_ten)}}'">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-cyan h1 font-weight-bold">Cập nhật tôn giáo</div>
                <div class="card-body">
                    <form name="frmEdit" id="frmEdit" method="POST" action="{{route('admin.tongiao.update', ['id' => $tg->tg_ma])}}" enctype="multipart/form-data" novalidate>
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" value="PUT">
                        <div class="form-group">
                            <label for="tg_ten">Tên tôn giáo :</label>
                            <input type="text" name="tg_ten" id="tg_ten" ng-model="tg_ten" ng-class="['form-control', frmEdit.tg_ten.$invalid?'is-invalid':'is-valid']" ng-model="tg_ten" ng-required="true" ng-minlength="3" ng-maxlength="50">
                            <div class="invalid-feedback">
                                <span ng-if="frmEdit.tg_ten.$error.required">Bạn phải nhập vào trường này</span>
                                <span ng-if="frmEdit.tg_ten.$error.minlength">Bạn nhập quá ngắn</span>
                                <span ng-if="frmEdit.tg_ten.$error.maxlength">Bạn nhập quá dài</span>
                            </div>
                        </div>
                        <div class="form-group">
