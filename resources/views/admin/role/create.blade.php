            ...
            <div class="row form-group">
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" ng-class="frmCreate.role_ten.$touched?frmCreate.role_ten.$invalid?'form-control is-invalid':'form-control is-valid':'form-control'"  id="role_ten" name="role_ten" value="{{old('role_ten')}}"  ng-model="role_ten" ng-required="true" ng-minlength="5" ng-maxlength="50">    
                  <div class="invalid-feedback">
                    <span ng-show="frmCreate.role_ten.$error.required">Bạn phải điền tên role</span>
                    <span ng-show="frmCreate.role_ten.$error.minlength">>Tên role phải chứa ít nhất 5 ký tự</span>
            ...
            <div class="row form-group">
              <div class="col">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" ng-class="frmCreate.role_mota.$touched?frmCreate.role_mota.$invalid?'form-control is-invalid':'form-control is-valid':'form-control'"  id="role_mota" name="role_mota" value="{{old('role_mota')}}"  ng-model="role_mota" ng-required="true" ng-minlength="5" ng-maxlength="100">    
                  <div class="invalid-feedback">
                    <span ng-show="frmCreate.role_mota.$error.required">Bạn phải điền mô tả</span>
                    <span ng-show="frmCreate.role_mota.$error.minlength">Mô tả phải chứa ít nhất 5 ký tự</span>
                    <span ng-show="frmCreate.role_mota.$error.maxlength">Mô tả chỉ chứa nhiều nhất 100 ký tự</span>
                  </div>
                </div> 
              </div>
            </div>
